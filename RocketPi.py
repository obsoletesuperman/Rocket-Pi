...
'///////////////////////Code from BerryIMU.py for gyro, accel and compass with filters //////////
...
'////////////////////////////// Code for Chat Relay Connection /////////////////
try:
    s.bind((host,port))
...
def threaded_client(conn):
    conn.send(str.encode('Welcome, You are connected to a friggin ROCKET!\n'))
